...
parser.add_argument('--beta', type=int, default=64, help='Page span in blocks (page_size / block_size)')
parser.add_argument('--alpha', type=float, default=0.4, help='Intra-page locality discount')
