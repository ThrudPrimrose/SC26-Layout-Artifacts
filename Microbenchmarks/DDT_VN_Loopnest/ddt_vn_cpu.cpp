...
struct Grp_D{int N,Nc,Nv,nlev;size_t se,szA,szD;
    double*__restrict__ grpA,*__restrict__ grpD,*__restrict__ z_kin_hor_e,*__restrict__ ddqz_z_full_e,*__restrict__ f_e,*__restrict__ coeff_gradekin,*__restrict__ c_lin_e,*__restrict__ zeta;int*__restrict__ cell_idx,*__restrict__ vert_idx;double*__restrict__ out;
