...
sleep 1
python zsolqa_loopnest.py --variant=reduce_split-gpu --reps=100 --csv bench_reduce_split_gpu.csv
sleep 1
...
sleep 1
python zsolqa_loopnest.py --variant=reduce_split --reps=100 --csv bench_reduce_split.csv
