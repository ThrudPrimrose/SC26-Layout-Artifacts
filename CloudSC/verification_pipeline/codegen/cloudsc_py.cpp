...
void __program_cloudsc_py_internal(
    ...
    int klon, double ptsphy, double ydcst_rcpd, double ydcst_rd,
    ...
    for (jl = kidia; (jl < kfdia_plus_1_1); jl = (jl + 1)) {
      {
        ...
        }
        {
          ...
          tendency_loc_cld[(((jl + ((4 * klev) * klon)) + (klon * (jk - 1))) -
                            1)] = __out;
        }
      }
    }
...
#pragma omp parallel for
    ...
    for (jl = kidia; (jl < kfdia_plus_1_7); jl = (jl + 1)) {
      ...
      if ((__tmp1 || __tmp2)) {
        ...
        }
        {
          ...
          dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
              zqx + (((jl + ((4 * klev) * klon)) + (klon * (jk - 1))) - 1),
              &zqx_index_3, 1);
        ...
        }
        {
          ...
          dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
              zlneg + (((jl + (klev * klon)) + (klon * (jk - 1))) - 1),
              &zlneg_index_0, 1);
          {
  ...
  for (jk = yrecldp_ncldtop; (jk < (klev + 1)); jk = (jk + 1)) {
        ...
        for (jl = kidia; (jl < kfdia_plus_1_16); jl = (jl + 1)) {
          {

            {
              ...
              zsolqb[(((jl + ((5 * klon) * (jm - 1))) + (klon * (jn - 1))) -
                      1)] = __out;
            }
            {
              double __out;
              ...
              zsolqa[(((jl + ((5 * klon) * (jm - 1))) + (klon * (jn - 1))) -
                      1)] = __out;
            }
          }
        }
          ...
          for (jl = kidia; (jl < kfdia_plus_1_26); jl = (jl + 1)) {
            {
              ...
              dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                  zsolqa + (((jl + ((5 * klon) * (jm - 1))) + (4 * klon)) - 1),
                  &zsolqa_index_9, 1);
              {
        ...
        for (jl = kidia; (jl < kfdia_plus_1_45); jl = (jl + 1)) {
          ...
          if (((zmeltmax_index > 1e-14) && (zicetot_index_0 > 1e-14))) {
            ...
            imelt_index_4 = imelt[(jm - 1)];
            {
              ...
              dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                  zsolqa + (((jl + (klon * (imelt_index_1 - 1))) +
                             ((5 * klon) * (jm - 1))) -
                            1),
                  &zsolqa_index_40, 1);
              {
              ...
              }
              {
                ...
                zsolqa[(((jl + (klon * (imelt_index_2 - 1))) +
                         ((5 * klon) * (jm - 1))) -
                        1)] = __out;
              }

              dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                  zsolqa + (((jl + ((5 * klon) * (imelt_index_3 - 1))) +
                             (klon * (jm - 1))) -
                            1),
                  &zsolqa_index_41, 1);
              {
              ...
              }
              {
                ...
                zsolqa[(((jl + ((5 * klon) * (imelt_index_4 - 1))) +
                         (klon * (jm - 1))) -
                        1)] = __out;
              }
            }
    ...
    for (jl = kidia; (jl < kfdia_plus_1_46); jl = (jl + 1)) {
      ...
      zqx_index_37 =
          zqx[(((jl + ((2 * klev) * klon)) + (klon * (jk - 1))) - 1)];
        ...
        if ((__tmp209 && __tmp210)) {
          {
            ...
            dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                zqx + (((jl + ((3 * klev) * klon)) + (klon * (jk - 1))) - 1),
                &zqx_index_38, 1);
    ...
    for (jl = kidia; (jl < kfdia_plus_1_48); jl = (jl + 1)) {
      ...
      if (((zfrzmax_index_1 > 1e-14) && (zqxfg_index_29 > 1e-14))) {
        ...
        imelt_index_8 = imelt[0];
        {
          ...
          dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
              zsolqa + ((jl + (klon * (imelt_index_5 - 1))) - 1),
              &zsolqa_index_44, 1);
          {
          ...
          dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
              zsolqa + ((jl + ((5 * klon) * (imelt_index_7 - 1))) - 1),
              &zsolqa_index_45, 1);
          {
          ...
          if ((zsolqa_index_58 < 0.0)) {
            {
              ...
              }
              {
                ...
                zsolqa[(((jl + (klon * (jm - 1))) + ((5 * klon) * (jn - 1))) -
                        1)] = __out;
              }

              dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                  zsolqa +
                      (((jl + ((5 * klon) * (jm - 1))) + (klon * (jn - 1))) -
                       1),
                  &zsolqa_index_60, 1);
              {
          ...
          for (jl = kidia; (jl < kfdia_plus_1_64); jl = (jl + 1)) {
            {
              ...
              }
              {
                ...
                zqlhs[(((jl + ((5 * klon) * (jm - 1))) + (klon * (jn - 1))) -
                       1)] = __out;
              }
            }
        ...
        for (jl = kidia; (jl < kfdia_plus_1_67); jl = (jl + 1)) {
          {
            ...
            dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                zqlhs + ((jl + ((6 * klon) * (jn - 1))) - 1), &zqlhs_index_1,
                1);
            {
            ...
            }
            {
              ...
              zqlhs[(((jl + (klon * (jm - 1))) + ((5 * klon) * (jn - 1))) -
                     1)] = __out;
            }
          }
        }
          ...
          for (jl = kidia; (jl < kfdia_plus_1_68); jl = (jl + 1)) {
            {
              ...
              }
              {
                ...
                zqlhs[(((jl + ((5 * klon) * (ik - 1))) + (klon * (jm - 1))) -
                       1)] = __out;
              }
            }
          }
    ...
    for (jl = kidia; (jl < kfdia_plus_1_76); jl = (jl + 1)) {
      {
        ...
        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
            zpfplsx + ((((jk * klon) + jl) + ((3 * klon) * (klev + 1))) - 1),
            &zpfplsx_index_2, 1);

        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
            zpfplsx + ((((jk * klon) + jl) + ((2 * klon) * (klev + 1))) - 1),
            &zpfplsx_index_3, 1);
        {
    ...
    for (jl = kidia; (jl < kfdia_plus_1_84); jl = (jl + 1)) {
      {
        ...
        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
            zpfplsx +
                (((jl + (klon * (jk - 1))) + ((3 * klon) * (klev + 1))) - 1),
            &zpfplsx_index_6, 1);

        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
            zpfplsx + (((jl + (klon * (jk - 1))) + (klon * (klev + 1))) - 1),
            &zpfplsx_index_7, 1);
        {
  ...
  for (jk = 1; (jk < (klev + 1)); jk = (jk + 1)) {
    ...
    for (jl = kidia; (jl < kfdia_plus_1_86); jl = (jl + 1)) {
      ...
      }
      {
        ...
        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
            zlneg + (((jl + ((3 * klev) * klon)) + (klon * (jk - 1))) - 1),
            &zlneg_index_5, 1);
        {
        ...
        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
            zqxn2d + (((jl + ((2 * klev) * klon)) + (klon * (jk - 1))) - 1),
            &zqxn2d_index_0, 1);

        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
            zqx0 + (((jl + ((2 * klev) * klon)) + (klon * (jk - 1))) - 1),
            &zqx0_index_1, 1);
        {
        ...
        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
            zlneg + (((jl + ((2 * klev) * klon)) + (klon * (jk - 1))) - 1),
            &zlneg_index_3, 1);
        {
        ...
        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
            zqxn2d + (((jl + (klev * klon)) + (klon * (jk - 1))) - 1),
            &zqxn2d_index_1, 1);
        ...
        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
            zqxn2d + (((jl + ((3 * klev) * klon)) + (klon * (jk - 1))) - 1),
            &zqxn2d_index_2, 1);

        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
            zqx0 + (((jl + ((3 * klev) * klon)) + (klon * (jk - 1))) - 1),
            &zqx0_index_3, 1);
        {
...
DACE_EXPORTED void __program_cloudsc_py(
  ...
  __program_cloudsc_py_internal(
      ...
      kidia, klev, klon, ptsphy, ydcst_rcpd, ydcst_rd, ydcst_retv, ydcst_rg,
      ydcst_rlmlt, ydcst_rlstt, ydcst_rlvtt, ydcst_rtt, ydcst_rv, ydthf_r2es,
      ydthf_r3ies, ydthf_r3les, ydthf_r4ies, ydthf_r4les, ydthf_r5alscp,
      ydthf_r5alvcp, ydthf_r5ies, ydthf_r5les, ydthf_ralfdcp, ydthf_ralsdcp,
      ydthf_ralvdcp, ydthf_rkoop1, ydthf_rkoop2, ydthf_rtice, ydthf_rticecu,
      ydthf_rtwat, ydthf_rtwat_rtice_r, ydthf_rtwat_rticecu_r,
