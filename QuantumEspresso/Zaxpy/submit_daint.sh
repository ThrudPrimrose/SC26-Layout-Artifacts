#!/bin/bash
#SBATCH --job-name=zaxpy_gpu_daint
#SBATCH --nodes=1
#SBATCH --partition=normal
#SBATCH --time=02:00:00
#SBATCH --output=zaxpy_gpu_daint_%j.out
#SBATCH --error=zaxpy_gpu_daint_%j.err
#SBATCH --ntasks=1
...
nvcc -O3 -std=c++17 -arch=native zaxpy.cu -o zaxpy_indirect_sweep
./zaxpy_indirect_sweep